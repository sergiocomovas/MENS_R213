...
<p>
    <button type="submit" class="btn float-right btn-sm btn-outline-primary"><i class="fas fa-save"></i> Guardar<br>Ibiza</button>
    <big>Ibiza</big>
...
<!--
<p>Pillo <a href="https://wendy.log99.es/index.php/A_turnos/semanas/ibiza/<?php echo $semanavista; ?>/<?php echo $anyovista; ?>">data</a></p>
<p>Pillo <a href="https://wendy.log99.es/index.php/A_turnos/semanas/ibiza/<?php echo $semanaanterior; ?>/<?php echo $anyoanterior; ?>">data anterior</a></p>
-->

<?php

$url = "https://wendy.log99.es/index.php/A_turnos/semanas/ibiza/".$semanavista."/".$anyovista; 

//$urlanterior = "https://wendy.log99.es/index.php/A_turnos/semanas/ibiza/".$semanaanterior."/".$anyoanterior; 

$urlultima = "https://wendy.log99.es/index.php/A_turnos/semanas/ibiza/".$semanaanterior."/".$anyoultima; 
        ...
        <div style="width:250px;"  class="card m-y-1">
            ...
            <div class="card-block">
                ...
                <div class="float-right m-1">
                    <small>  <?php echo $turnos[datos][0][ib_autodate]; ?>  </small>
                </div>
                <br>
            </div>
            ...
            <div class="card-block m-1"><!--inicio cardblock principal-->
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control form-control-lg" 
                        ...
                        id="ib_ibiza" 
                        name="ib_ibiza"
                        rows="6"><?php echo $turnos[datos][0][ib_ibiza]; ?></textarea>
                    
                    <label for="ib_ibiza">
                        <a onClick="cambiarVar('ib_ibiza','<?php echo $turnosultima[datos][0][ib_ibiza]; ?>')" href="#!"><i class="far fa-copy"></i> Copiar última.</a>
                    </label>
...
<p style="color:#dc3545;"> ¿Desea añadir algún comentario?</p>
    <textarea class="form-control form-control-lg" 
        ...
        id="ib_comentarios" 
        name="ib_comentarios"
        rows="8"><?php echo $turnos[datos][0][ib_comentarios]; ?></textarea><br>

<p style="color:#dc3545;"> Por Favor: acuérdese de guardar. </p>
    <button type="submit"  class="btn btn-danger btn-lg btn-block">Guardar Ibiza</button>
