...
<html>
  <head>
    ...
    <link href="https://oklgrtuhcu.log99.es/MENS_R213/8_APP_MENSAJERO/rrr_css/ratchet.css" rel="stylesheet">

    <!-- Include the compiled Ratchet JS -->
    <script src="https://oklgrtuhcu.log99.es/MENS_R213/8_APP_MENSAJERO/rrr_js/ratchet.js"></script>
  </head>
  <body>
      ...
      <div class="card">
        <ul class="table-view">
          <li class="table-view-cell">
            <a class="push-right" href="/MENS_R213/8_APP_MENSAJERO/index.php/Control_horario/index2">
