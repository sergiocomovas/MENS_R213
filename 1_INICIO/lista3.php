...
<body>
      ...
      <div class="row">
        <div class="col-md-12">
        <h2>MAPA (LISTA 07003)  | <a href="" onclick="window.print()">IMPRIMIR <?php
 ...
 ?></a> </h2>
        <div style="height: 900px;" id="mapigeneral"></div>
                        <script>
                          ...
                          var mymapgeneral = L.map(`mapigeneral`,{zoomControl: false}).setView([ 39.576828, 2.647505 ], 16);
          ...
          <table class="table">
           ...
           <?php 
            ...
            $sql = ("
                    ...
                    AND  `1_MR_REPARTO`.`CP_CP` LIKE '%7003%'                  
