...
<div id="tree-filter" class="input-group">
    <input type="text" id="tree-filter-query" placeholder="Buscar" class="form-control input-sm">
    <a id="tree-filter-clear-query" title="Borrar búsqueda actual" class="input-group-addon input-sm">
